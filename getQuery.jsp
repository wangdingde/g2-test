...
<%
	...
	try {
		...
		//System.out.println("accNo := " + accNo + "\tsqlNo := " + sqlNo + "\twhereStr := " + whereStr + "\topType := " + opType);
		//String str = AppFactoryClf.getInstance().gateQuerySql(Long.valueOf(usr.get("USRS_ID").toString()), menu_id, accNo, sqlNo,opType,whereStr,map);
		//System.out.println(str);
		String str = AppFactoryClf.instanceQueryJson(accNo, sqlNo, opType, whereStr, map,true);
		writer.write(str);
	}catch(Exception e){
		e.printStackTrace();
